...
def generate_client_key_pair():
    ...
    with open("client3_private_key.pem", "wb") as f:
    ...
    with open("client3_public_key.pem", "wb") as f:
...
csr = create_csr(client_private_key, u"client3.example.com")
...
def on_message(client, userdata, msg):
    ...
    if certificate:
        with open("client3_certificate.pem", "w") as f:
            f.write(certificate)
        print("Certificate received and saved as client3_certificate.pem")
